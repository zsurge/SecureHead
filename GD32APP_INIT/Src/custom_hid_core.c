...
#define USBD_HID_PID                 0x2030
#define USBD_OTHER_PID               0x2020
#define USBD_KB_PID                  0x2010
...
//    DBG_S("custom_hid_data_handler[USBD_TX] usbd_dir_enum = %d,ep_id = %d\r\n",rx_tx,ep_id);
        return USBD_OK;
    } else if ((USBD_RX == rx_tx) && (CUSTOMHID_OUT_EP == ep_id)) {    
//    DBG_S("custom_hid_data_handler [USBD_RX] usbd_dir_enum = %d,ep_id = %d\r\n",rx_tx,ep_id);
