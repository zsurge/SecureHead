...
/* LPM Registers */
#define USBD_SEP0                      (REG32(USBD + 0x100U))  /*!< sub endpoint0 register(for LPM) */
#define USBD_LPMCTL                    (REG32(USBD + 0x140U))  /*!< LPM interrupt control register */
#define USBD_LPMINTF                   (REG32(USBD + 0x144U))  /*!< LPM interrupt status register */
