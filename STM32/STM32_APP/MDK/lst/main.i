...
void RCC_Configuration(void)
{
	...
	while(RCC_GetFlagStatus(((unsigned char)0x21)) == RESET);
	
	
	FLASH_PrefetchBufferCmd(((unsigned int)0x00000010));
	
	
	FLASH_SetLatency(((unsigned int)0x00000002));
   
	
	RCC_HCLKConfig(((unsigned int)0x00000000));
   
	
	RCC_PCLK2Config(((unsigned int)0x00000000));
  
	
	RCC_PCLK1Config(((unsigned int)0x00000400));
    
	
	RCC_PLLConfig(((unsigned int)0x00000000), ((unsigned int)0x001C0000));   
                
	
	RCC_PLLCmd(ENABLE);

	
	while(RCC_GetFlagStatus(((unsigned char)0x39)) == RESET);	

	
	RCC_SYSCLKConfig(((unsigned int)0x00000002));
...
{
	NVIC_SetVectorTable(((unsigned int)0x08000000), 0);
}
...
{
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL &= 0xfffffffb;
	fac_us = SYSCLK / 8;      
	fac_ms = fac_us * 1000;
}            
...
{         
	unsigned int temp;     
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = nms * fac_ms;				
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL  = 0x00;						
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = 0x01;						
	do {
...
void EXTI_Configuration(void)
{
	...
	GPIO_Init(((GPIO_TypeDef *) ((((unsigned int)0x40000000) + 0x10000) + 0x0C00)), &GPIO_InitStructure);

	NVIC_PriorityGroupConfig(((unsigned int)0x700));					
	NVIC_InitStructure.NVIC_IRQChannel    = EXTI4_IRQn;				
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 0;		
	NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;					
	NVIC_Init(&NVIC_InitStructure);

	GPIO_EXTILineConfig(((unsigned char)0x01), ((unsigned char)0x02));		
	EXTI_InitStructure.EXTI_Line    = ((unsigned int)0x00004);					
	...
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_IN_FLOATING;			
	GPIO_Init(((GPIO_TypeDef *) ((((unsigned int)0x40000000) + 0x10000) + 0x0800)), &GPIO_InitStructure);
	...
	GPIO_EXTILineConfig(((unsigned char)0x00), ((unsigned char)0x07));	
	EXTI_InitStructure.EXTI_Line    = ((unsigned int)0x00080);					
	EXTI_InitStructure.EXTI_Mode    = EXTI_Mode_Interrupt;			
	EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Rising_Falling;	
	EXTI_InitStructure.EXTI_LineCmd = ENABLE;						
	EXTI_Init(&EXTI_InitStructure);
	...
	GPIO_EXTILineConfig(((unsigned char)0x01), ((unsigned char)0x00));		
	EXTI_InitStructure.EXTI_Line    = ((unsigned int)0x00001);					
	EXTI_InitStructure.EXTI_Mode    = EXTI_Mode_Interrupt;			
	EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Rising_Falling;	
	EXTI_InitStructure.EXTI_LineCmd = ENABLE;						
	EXTI_Init(&EXTI_InitStructure);
	...
	GPIO_EXTILineConfig(((unsigned char)0x01), ((unsigned char)0x01));		
	EXTI_InitStructure.EXTI_Line    = ((unsigned int)0x00002);					
	EXTI_InitStructure.EXTI_Mode    = EXTI_Mode_Interrupt;			
	EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Rising_Falling;	
	EXTI_InitStructure.EXTI_LineCmd = ENABLE;						
	EXTI_Init(&EXTI_InitStructure);
...
void RTC_Configuration(void)
{
	...
	while (RCC_GetFlagStatus(((unsigned char)0x61)) == RESET)
	{}
	
	 
	RCC_RTCCLKConfig(((unsigned int)0x00000200));
	...
	NVIC_PriorityGroupConfig(((unsigned int)0x500));
...
void IWDG_Configuration(void)
{
	...
	IWDG_SetPrescaler(((unsigned char)0x04));
...
extern volatile unsigned char TM1CaptureNumber;
extern volatile unsigned char TM2CaptureNumber;
extern volatile unsigned char TM3CaptureNumber;
int main(void)
{
	int ret;
	unsigned char Buf[110];
#line 417 "..\\user\\main.c"

	
	dev_com_open();		
	uart_puts("APP Start...\r\n");
	
#line 490 "..\\user\\main.c"
